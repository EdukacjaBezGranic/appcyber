(() => {
  ...
  const messages = {
    ...
    creator: {
      className: 'correct',
      title: 'Trafna ocena: realny twórca, niewiarygodny model działania.',
      body: 'PolskiLis78 jest fikcyjną polską adaptacją anonimowego influencera. Prawdziwa osoba monetyzuje rage bait i może odpłatnie nadawać zasięg materiałom przygotowanym przez cudzą operację wpływu.'
    }
  };
