(() => {
  ...
  const messages = {
    human: {
      className: 'incorrect',
      title: 'To nie jest zwykłe konto aktywistki.',
      body: 'Silne poglądy nie są dowodem manipulacji. Decyduje cały wzorzec: wyłącznie polityczna aktywność, seryjne wybieranie tematów zapalnych, brak codzienności i ciągłe prowokowanie prostych, emocjonalnych reakcji.'
    },
    operation: {
      className: 'correct',
      title: 'Trafna ocena: persona operacji wpływu.',
      body: 'Karolina jest fikcyjną polską adaptacją państwowego konta wpływu. Udaje lokalną aktywistkę, ale cały profil służy podbijaniu polaryzujących sporów i wywoływaniu zaangażowania politycznego.'
    }
  };
