(() => {
  ...
  const STATE_KEY = 'ebgCourseR2State';
  const VERSION = 'R2-2026-08-30';
  const PASS_SCORE = 7;
  ...
  function initNavigation(){
    $('#startCourse')?.addEventListener('click',()=>$('#r2-m1-1')?.scrollIntoView({behavior:'smooth',block:'start'}));
