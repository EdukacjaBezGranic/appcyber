  ...
  function renderSidebar(){
    ...
    $$('.course-module').forEach((article,i)=>{
      ...
      lessons.forEach((sec,lessonIndex)=>{
        ...
        a.innerHTML=`<span class="sidebar-lesson__num">${lessonIndex+1}</span><span class="sidebar-lesson__title">${escapeHtml(sectionTitle(sec))}</span><span class="sidebar-lesson__status" aria-hidden="true">${state.completed.includes(sec.id)?'✓':''}</span>`;
